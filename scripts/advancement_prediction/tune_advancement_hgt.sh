...
# W&B-sweep hyperparameter tuning for clinical trial advancement HGT.
#
...
#
# Usage:
#   bash scripts/advancement_prediction/tune_advancement_hgt.sh [options]
#   sbatch scripts/advancement_prediction/tune_advancement_hgt.sh [options]
#
# Options:
...
# ── Build command ─────────────────────────────────────────────────────────────
CMD=(
    python src/tune_advancement_hgt.py
    --config "$CONFIG"
)
